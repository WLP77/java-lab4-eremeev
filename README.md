...
На GitHub нужно создать пустой репозиторий с названием:

```text
java-lab4-eremeev
```

При создании репозитория не нужно включать:
...
После создания репозитория открыть Terminal и выполнить:
...
git branch -M main
git remote add origin https://github.com/WLP77/java-lab4-eremeev.git
git push -u origin main
```

Если репозиторий находится в другом GitHub-аккаунте, нужно заменить `WLP77` на свой логин:

```bash
git remote add origin https://github.com/ТВОЙ_ЛОГИН/java-lab4-eremeev.git
```

Если GitHub попросит пароль, обычный пароль от аккаунта не подойдет. Вместо пароля нужно использовать Personal Access Token.
